...
<div class="col-md-6">  
<ul>
<li class="list-group-item"><a href="#" ><?php echo $value['number_articles'];?></a></li>
...
<a href="Article-profiles"><button class="btn  btn-default btn-xs">Manage Articles</button></a>
