...
<a href="index"><b>Admin</b> Postslinks</a>
...
<?php 
if(isset($_SESSION[msg])) { echo "<p class='text-danger login-box-msg'><strong>$_SESSION[msg]</strong></p>";}
unset($_SESSION[msg]);
?>
